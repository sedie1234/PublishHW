...
typedef struct iree_halhw1buffer_t {
  iree_hal_buffer_t base;
  iree_allocator_t host_allocator;
  iree_hal_buffer_release_callback_t release_callback;
} iree_halhw1buffer_t;

static const iree_hal_buffer_vtable_t iree_halhw1buffer_vtable;

static iree_halhw1buffer_t* iree_halhw1buffer_cast(
    iree_hal_buffer_t* base_value) {
  IREE_HAL_ASSERT_TYPE(base_value, &iree_halhw1buffer_vtable);
  return (iree_halhw1buffer_t*)base_value;
}

static const iree_halhw1buffer_t* iree_halhw1buffer_const_cast(
    const iree_hal_buffer_t* base_value) {
  IREE_HAL_ASSERT_TYPE(base_value, &iree_halhw1buffer_vtable);
  return (const iree_halhw1buffer_t*)base_value;
}

iree_status_t iree_halhw1buffer_wrap(
  ...
  *out_buffer = NULL;
  ...
  iree_halhw1buffer_t* buffer = NULL;
  ...
  iree_hal_buffer_initialize(placement, &buffer->base, allocation_size,
                             ...
                             &iree_halhw1buffer_vtable, &buffer->base);
...
static void iree_halhw1buffer_destroy(iree_hal_buffer_t* base_buffer) {
  iree_halhw1buffer_t* buffer = iree_halhw1buffer_cast(base_buffer);
...
static iree_status_t iree_halhw1buffer_map_range(
...
static iree_status_t iree_halhw1buffer_unmap_range(
...
static iree_status_t iree_halhw1buffer_invalidate_range(
    iree_hal_buffer_t* base_buffer, iree_device_size_t local_byte_offset,
...
static iree_status_t iree_halhw1buffer_flush_range(
    iree_hal_buffer_t* base_buffer, iree_device_size_t local_byte_offset,
    iree_device_size_t local_byte_length) {
  iree_halhw1buffer_t* buffer = iree_halhw1buffer_cast(base_buffer);
...
static const iree_hal_buffer_vtable_t iree_halhw1buffer_vtable = {
    ...
    .destroy = iree_halhw1buffer_destroy,
    .map_range = iree_halhw1buffer_map_range,
    .unmap_range = iree_halhw1buffer_unmap_range,
    .invalidate_range = iree_halhw1buffer_invalidate_range,
    .flush_range = iree_halhw1buffer_flush_range,
};
