...
//===----------------------------------------------------------------------===//
// iree_halhw1executable_t
//===----------------------------------------------------------------------===//

typedef struct iree_halhw1executable_t {
  iree_hal_resource_t resource;
  iree_allocator_t host_allocator;
} iree_halhw1executable_t;

static const iree_hal_executable_vtable_t iree_halhw1executable_vtable;

static iree_halhw1executable_t* iree_halhw1executable_cast(
    iree_hal_executable_t* base_value) {
  IREE_HAL_ASSERT_TYPE(base_value, &iree_halhw1executable_vtable);
  return (iree_halhw1executable_t*)base_value;
}

iree_status_t iree_halhw1executable_create(
  ...
  *out_executable = NULL;
  ...
  iree_halhw1executable_t* executable = NULL;
  IREE_RETURN_AND_END_ZONE_IF_ERROR(
      z0, iree_allocator_malloc(host_allocator, sizeof(*executable),
                                (void**)&executable));
  iree_hal_resource_initialize(&iree_halhw1executable_vtable,
                               &executable->resource);
...
static void iree_halhw1executable_destroy(
    iree_hal_executable_t* base_executable) {
  iree_halhw1executable_t* executable =
      iree_halhw1executable_cast(base_executable);
...
static iree_host_size_t iree_halhw1executable_export_count(
    iree_hal_executable_t* base_executable) {
  iree_halhw1executable_t* executable =
      iree_halhw1executable_cast(base_executable);
...
static iree_status_t iree_halhw1executable_export_info(
    iree_hal_executable_t* base_executable,
...
static iree_status_t iree_halhw1executable_export_parameters(
    iree_hal_executable_t* base_executable,
    iree_hal_executable_export_ordinal_t export_ordinal,
...
static iree_status_t iree_halhw1executable_lookup_export_by_name(
...
static const iree_hal_executable_vtable_t iree_halhw1executable_vtable = {
    .destroy = iree_halhw1executable_destroy,
    .export_count = iree_halhw1executable_export_count,
    .export_info = iree_halhw1executable_export_info,
    .export_parameters = iree_halhw1executable_export_parameters,
    .lookup_export_by_name = iree_halhw1executable_lookup_export_by_name,
};
