...
1. Find/replace `Hw1` with the friendly name of your driver (e.g. `Vulkan`).
1. Find/replace `hw1` with the C name of your driver (e.g. `vulkan`).
1. Find/replace `HW1` with the upper C name of your driver (e.g. `VULKAN`).
