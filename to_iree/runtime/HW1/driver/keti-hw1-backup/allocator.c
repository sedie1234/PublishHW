...
static const char* IREE_HALHW1ALLOCATOR_ID = "Hw1 unpooled";
#endif  // IREE_TRACING_FEATURE_ALLOCATION_TRACKING

typedef struct iree_halhw1allocator_t {
...
static const iree_hal_allocator_vtable_t iree_halhw1allocator_vtable;

static iree_halhw1allocator_t* iree_halhw1allocator_cast(
    iree_hal_allocator_t* base_value) {
  IREE_HAL_ASSERT_TYPE(base_value, &iree_halhw1allocator_vtable);
  return (iree_halhw1allocator_t*)base_value;
}
...
iree_status_t iree_halhw1allocator_create(
  ...
  *out_allocator = NULL;
  ...
  iree_halhw1allocator_t* allocator = NULL;
  IREE_RETURN_AND_END_ZONE_IF_ERROR(
      z0, iree_allocator_malloc(host_allocator, sizeof(*allocator),
                                (void**)&allocator));
  iree_hal_resource_initialize(&iree_halhw1allocator_vtable,
                               &allocator->resource);
...
static void iree_halhw1allocator_destroy(
    iree_hal_allocator_t* IREE_RESTRICT base_allocator) {
  IREE_ASSERT_ARGUMENT(base_allocator);
  iree_halhw1allocator_t* allocator =
      iree_halhw1allocator_cast(base_allocator);
  IREE_TRACE_ZONE_BEGIN(z0);
...
static iree_allocator_t iree_halhw1allocator_host_allocator(
    const iree_hal_allocator_t* IREE_RESTRICT base_allocator) {
  iree_halhw1allocator_t* allocator =
      (iree_halhw1allocator_t*)base_allocator;
  return allocator->host_allocator;
}

static iree_status_t iree_halhw1allocator_trim(
    iree_hal_allocator_t* IREE_RESTRICT base_allocator) {
  iree_halhw1allocator_t* allocator =
      (iree_halhw1allocator_t*)base_allocator;
...
static void iree_halhw1allocator_query_statistics(
    iree_hal_allocator_t* IREE_RESTRICT base_allocator,
...
static iree_status_t iree_halhw1allocator_query_memory_heaps(
    iree_hal_allocator_t* IREE_RESTRICT base_allocator,
...
iree_halhw1allocator_query_buffer_compatibility(
    iree_hal_allocator_t* IREE_RESTRICT base_allocator,
...
static iree_status_t iree_halhw1allocator_allocate_buffer(
    iree_hal_allocator_t* IREE_RESTRICT base_allocator,
  ...
  // is live. An example iree_halhw1buffer_wrap is provided that can be used
  ...
  if (iree_status_is_ok(status)) {
    ...
    IREE_TRACE_ALLOC_NAMED(IREE_HALHW1ALLOCATOR_ID, impl_ptr,
                           allocation_size);
...
static void iree_halhw1allocator_deallocate_buffer(
    iree_hal_allocator_t* IREE_RESTRICT base_allocator,
  ...
  if (!was_imported) {
    IREE_TRACE_FREE_NAMED(IREE_HALHW1ALLOCATOR_ID, impl_ptr);
...
static iree_status_t iree_halhw1allocator_import_buffer(
    iree_hal_allocator_t* IREE_RESTRICT base_allocator,
    const iree_hal_buffer_params_t* IREE_RESTRICT params,
...
static iree_status_t iree_halhw1allocator_export_buffer(
    iree_hal_allocator_t* IREE_RESTRICT base_allocator,
...
static const iree_hal_allocator_vtable_t iree_halhw1allocator_vtable = {
    .destroy = iree_halhw1allocator_destroy,
    .host_allocator = iree_halhw1allocator_host_allocator,
    .trim = iree_halhw1allocator_trim,
    .query_statistics = iree_halhw1allocator_query_statistics,
    .query_memory_heaps = iree_halhw1allocator_query_memory_heaps,
    .query_buffer_compatibility =
        iree_halhw1allocator_query_buffer_compatibility,
    .allocate_buffer = iree_halhw1allocator_allocate_buffer,
    .deallocate_buffer = iree_halhw1allocator_deallocate_buffer,
    .import_buffer = iree_halhw1allocator_import_buffer,
    .export_buffer = iree_halhw1allocator_export_buffer,
};
