...
//===----------------------------------------------------------------------===//
// iree_halhw1executable_cache_t
//===----------------------------------------------------------------------===//

typedef struct iree_halhw1executable_cache_t {
  iree_hal_resource_t resource;
  iree_allocator_t host_allocator;
} iree_halhw1executable_cache_t;

static const iree_hal_executable_cache_vtable_t
    iree_halhw1executable_cache_vtable;

static iree_halhw1executable_cache_t* iree_halhw1executable_cache_cast(
    iree_hal_executable_cache_t* base_value) {
  IREE_HAL_ASSERT_TYPE(base_value, &iree_halhw1executable_cache_vtable);
  return (iree_halhw1executable_cache_t*)base_value;
}

iree_status_t iree_halhw1executable_cache_create(
  ...
  *out_executable_cache = NULL;
  ...
  iree_halhw1executable_cache_t* executable_cache = NULL;
  IREE_RETURN_AND_END_ZONE_IF_ERROR(
      z0, iree_allocator_malloc(host_allocator, sizeof(*executable_cache),
                                (void**)&executable_cache));
  iree_hal_resource_initialize(&iree_halhw1executable_cache_vtable,
...
static void iree_halhw1executable_cache_destroy(
    iree_hal_executable_cache_t* base_executable_cache) {
  iree_halhw1executable_cache_t* executable_cache =
      iree_halhw1executable_cache_cast(base_executable_cache);
...
static iree_status_t iree_halhw1executable_cache_infer_format(
    iree_hal_executable_cache_t* base_executable_cache,
...
static bool iree_halhw1executable_cache_can_prepare_format(
    iree_hal_executable_cache_t* base_executable_cache,
    iree_hal_executable_caching_mode_t caching_mode,
...
static iree_status_t iree_halhw1executable_cache_prepare_executable(
    iree_hal_executable_cache_t* base_executable_cache,
  ...
  return iree_halhw1executable_create(
      executable_params, executable_cache->host_allocator, out_executable);
}

static const iree_hal_executable_cache_vtable_t
    iree_halhw1executable_cache_vtable = {
        .destroy = iree_halhw1executable_cache_destroy,
        .infer_format = iree_halhw1executable_cache_infer_format,
        .can_prepare_format = iree_halhw1executable_cache_can_prepare_format,
        .prepare_executable = iree_halhw1executable_cache_prepare_executable,
};
