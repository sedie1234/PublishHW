...
//===----------------------------------------------------------------------===//
// iree_halhw1device_options_t
//===----------------------------------------------------------------------===//

IREE_API_EXPORT void iree_halhw1device_options_initialize(
    iree_halhw1device_options_t* out_options) {
...
static iree_status_t iree_halhw1device_options_verify(
    const iree_halhw1device_options_t* options) {
...
typedef struct iree_halhw1device_t {
...
static const iree_hal_device_vtable_t iree_halhw1device_vtable;

static iree_halhw1device_t* iree_halhw1device_cast(
    iree_hal_device_t* base_value) {
  IREE_HAL_ASSERT_TYPE(base_value, &iree_halhw1device_vtable);
  return (iree_halhw1device_t*)base_value;
}

iree_status_t iree_halhw1device_create(
    iree_string_view_t identifier,
    const iree_halhw1device_options_t* options,
  ...
  *out_device = NULL;
  ...
  IREE_RETURN_AND_END_ZONE_IF_ERROR(
      z0, iree_halhw1device_options_verify(options));

  iree_halhw1device_t* device = NULL;
  iree_host_size_t total_size = sizeof(*device) + identifier.size;
  IREE_RETURN_AND_END_ZONE_IF_ERROR(
      z0, iree_allocator_malloc(host_allocator, total_size, (void**)&device));
  iree_hal_resource_initialize(&iree_halhw1device_vtable, &device->resource);
  ...
  iree_status_t status =
      iree_halhw1allocator_create(host_allocator, &device->device_allocator);
...
static void iree_halhw1device_destroy(iree_hal_device_t* base_device) {
  iree_halhw1device_t* device = iree_halhw1device_cast(base_device);
...
static iree_string_view_t iree_halhw1device_id(
    iree_hal_device_t* base_device) {
  iree_halhw1device_t* device = iree_halhw1device_cast(base_device);
  return device->identifier;
}

static iree_allocator_t iree_halhw1device_host_allocator(
    iree_hal_device_t* base_device) {
  iree_halhw1device_t* device = iree_halhw1device_cast(base_device);
  return device->host_allocator;
}

static iree_hal_allocator_t* iree_halhw1device_allocator(
    iree_hal_device_t* base_device) {
  iree_halhw1device_t* device = iree_halhw1device_cast(base_device);
  return device->device_allocator;
}

static void iree_halhw1replace_device_allocator(
...
static void iree_halhw1replace_channel_provider(
...
static iree_status_t iree_halhw1device_trim(iree_hal_device_t* base_device) {
  iree_halhw1device_t* device = iree_halhw1device_cast(base_device);
...
static iree_status_t iree_halhw1device_query_i64(
...
static iree_status_t iree_halhw1device_create_channel(
  ...
  return iree_halhw1channel_create(
      params, iree_hal_device_host_allocator(base_device), out_channel);
}

static iree_status_t iree_halhw1device_create_command_buffer(
  ...
  return iree_halhw1command_buffer_create(
      iree_hal_device_allocator(base_device), mode, command_categories,
      queue_affinity, binding_capacity, device->host_allocator,
      out_command_buffer);
}

static iree_status_t iree_halhw1device_create_event(
    iree_hal_device_t* base_device, iree_hal_queue_affinity_t queue_affinity,
  ...
  return iree_halhw1event_create(queue_affinity, flags,
                                    iree_hal_device_host_allocator(base_device),
                                    out_event);
}

static iree_status_t iree_halhw1device_create_executable_cache(
  ...
  return iree_halhw1executable_cache_create(
      identifier, iree_hal_device_host_allocator(base_device),
      out_executable_cache);
}

static iree_status_t iree_halhw1device_import_file(
    iree_hal_device_t* base_device, iree_hal_queue_affinity_t queue_affinity,
...
static iree_status_t iree_halhw1device_create_semaphore(
    iree_hal_device_t* base_device, iree_hal_queue_affinity_t queue_affinity,
  ...
  return iree_halhw1semaphore_create(queue_affinity, initial_value, flags,
                                        device->host_allocator, out_semaphore);
}

static iree_hal_semaphore_compatibility_t
iree_halhw1device_query_semaphore_compatibility(
...
static iree_status_t iree_halhw1device_queue_alloca(
    iree_hal_device_t* base_device, iree_hal_queue_affinity_t queue_affinity,
...
static iree_status_t iree_halhw1device_queue_dealloca(
    iree_hal_device_t* base_device, iree_hal_queue_affinity_t queue_affinity,
    const iree_hal_semaphore_list_t wait_semaphore_list,
    const iree_hal_semaphore_list_t signal_semaphore_list,
...
static iree_status_t iree_halhw1device_queue_fill(
    iree_hal_device_t* base_device, iree_hal_queue_affinity_t queue_affinity,
    const iree_hal_semaphore_list_t wait_semaphore_list,
    const iree_hal_semaphore_list_t signal_semaphore_list,
...
static iree_status_t iree_halhw1device_queue_update(
    iree_hal_device_t* base_device, iree_hal_queue_affinity_t queue_affinity,
    const iree_hal_semaphore_list_t wait_semaphore_list,
    const iree_hal_semaphore_list_t signal_semaphore_list,
...
static iree_status_t iree_halhw1device_queue_copy(
    iree_hal_device_t* base_device, iree_hal_queue_affinity_t queue_affinity,
    const iree_hal_semaphore_list_t wait_semaphore_list,
    const iree_hal_semaphore_list_t signal_semaphore_list,
...
static iree_status_t iree_halhw1device_queue_read(
    iree_hal_device_t* base_device, iree_hal_queue_affinity_t queue_affinity,
    const iree_hal_semaphore_list_t wait_semaphore_list,
    const iree_hal_semaphore_list_t signal_semaphore_list,
...
static iree_status_t iree_halhw1device_queue_write(
    iree_hal_device_t* base_device, iree_hal_queue_affinity_t queue_affinity,
    const iree_hal_semaphore_list_t wait_semaphore_list,
    const iree_hal_semaphore_list_t signal_semaphore_list,
    iree_hal_buffer_t* source_buffer, iree_device_size_t source_offset,
...
static iree_status_t iree_halhw1device_queue_host_call(
    iree_hal_device_t* base_device, iree_hal_queue_affinity_t queue_affinity,
    const iree_hal_semaphore_list_t wait_semaphore_list,
    const iree_hal_semaphore_list_t signal_semaphore_list,
...
static iree_status_t iree_halhw1device_queue_dispatch(
    iree_hal_device_t* base_device, iree_hal_queue_affinity_t queue_affinity,
    const iree_hal_semaphore_list_t wait_semaphore_list,
    const iree_hal_semaphore_list_t signal_semaphore_list,
...
static iree_status_t iree_halhw1device_queue_execute(
    iree_hal_device_t* base_device, iree_hal_queue_affinity_t queue_affinity,
    const iree_hal_semaphore_list_t wait_semaphore_list,
    const iree_hal_semaphore_list_t signal_semaphore_list,
...
static iree_status_t iree_halhw1device_queue_flush(
    iree_hal_device_t* base_device, iree_hal_queue_affinity_t queue_affinity) {
  iree_halhw1device_t* device = iree_halhw1device_cast(base_device);
...
static iree_status_t iree_halhw1device_wait_semaphores(
...
static iree_status_t iree_halhw1device_profiling_begin(
    iree_hal_device_t* base_device,
...
static iree_status_t iree_halhw1device_profiling_flush(
    iree_hal_device_t* base_device) {
  iree_halhw1device_t* device = iree_halhw1device_cast(base_device);
...
static iree_status_t iree_halhw1device_profiling_end(
    iree_hal_device_t* base_device) {
  iree_halhw1device_t* device = iree_halhw1device_cast(base_device);
...
static const iree_hal_device_vtable_t iree_halhw1device_vtable = {
    .destroy = iree_halhw1device_destroy,
    .id = iree_halhw1device_id,
    .host_allocator = iree_halhw1device_host_allocator,
    .device_allocator = iree_halhw1device_allocator,
    .replace_device_allocator = iree_halhw1replace_device_allocator,
    .replace_channel_provider = iree_halhw1replace_channel_provider,
    .trim = iree_halhw1device_trim,
    .query_i64 = iree_halhw1device_query_i64,
    .create_channel = iree_halhw1device_create_channel,
    .create_command_buffer = iree_halhw1device_create_command_buffer,
    .create_event = iree_halhw1device_create_event,
    .create_executable_cache = iree_halhw1device_create_executable_cache,
    .import_file = iree_halhw1device_import_file,
    .create_semaphore = iree_halhw1device_create_semaphore,
    .query_semaphore_compatibility =
        iree_halhw1device_query_semaphore_compatibility,
    .queue_alloca = iree_halhw1device_queue_alloca,
    .queue_dealloca = iree_halhw1device_queue_dealloca,
    .queue_fill = iree_halhw1device_queue_fill,
    .queue_update = iree_halhw1device_queue_update,
    .queue_copy = iree_halhw1device_queue_copy,
    .queue_read = iree_halhw1device_queue_read,
    .queue_write = iree_halhw1device_queue_write,
    .queue_host_call = iree_halhw1device_queue_host_call,
    .queue_dispatch = iree_halhw1device_queue_dispatch,
    .queue_execute = iree_halhw1device_queue_execute,
    .queue_flush = iree_halhw1device_queue_flush,
    .wait_semaphores = iree_halhw1device_wait_semaphores,
    .profiling_begin = iree_halhw1device_profiling_begin,
    .profiling_flush = iree_halhw1device_profiling_flush,
    .profiling_end = iree_halhw1device_profiling_end,
};
