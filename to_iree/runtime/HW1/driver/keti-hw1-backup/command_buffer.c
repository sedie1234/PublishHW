...
//===----------------------------------------------------------------------===//
// iree_halhw1command_buffer_t
//===----------------------------------------------------------------------===//

typedef struct iree_halhw1command_buffer_t {
  iree_hal_command_buffer_t base;
  iree_allocator_t host_allocator;
} iree_halhw1command_buffer_t;

static const iree_hal_command_buffer_vtable_t
    iree_halhw1command_buffer_vtable;

static iree_halhw1command_buffer_t* iree_halhw1command_buffer_cast(
    iree_hal_command_buffer_t* base_value) {
  IREE_HAL_ASSERT_TYPE(base_value, &iree_halhw1command_buffer_vtable);
  return (iree_halhw1command_buffer_t*)base_value;
}

iree_status_t iree_halhw1command_buffer_create(
  ...
  *out_command_buffer = NULL;
  ...
  iree_halhw1command_buffer_t* command_buffer = NULL;
  ...
  iree_hal_command_buffer_initialize(
      ...
      &iree_halhw1command_buffer_vtable, &command_buffer->base);
...
static void iree_halhw1command_buffer_destroy(
    iree_hal_command_buffer_t* base_command_buffer) {
  iree_halhw1command_buffer_t* command_buffer =
      iree_halhw1command_buffer_cast(base_command_buffer);
...
bool iree_halhw1command_buffer_isa(
    iree_hal_command_buffer_t* command_buffer) {
  return iree_hal_resource_is(&command_buffer->resource,
                              &iree_halhw1command_buffer_vtable);
}

static iree_status_t iree_halhw1command_buffer_begin(
    iree_hal_command_buffer_t* base_command_buffer) {
  iree_halhw1command_buffer_t* command_buffer =
      iree_halhw1command_buffer_cast(base_command_buffer);
...
static iree_status_t iree_halhw1command_buffer_end(
    iree_hal_command_buffer_t* base_command_buffer) {
  iree_halhw1command_buffer_t* command_buffer =
      iree_halhw1command_buffer_cast(base_command_buffer);
...
static iree_status_t iree_halhw1command_buffer_begin_debug_group(
...
static iree_status_t iree_halhw1command_buffer_end_debug_group(
    iree_hal_command_buffer_t* base_command_buffer) {
  iree_halhw1command_buffer_t* command_buffer =
      iree_halhw1command_buffer_cast(base_command_buffer);
...
static iree_status_t iree_halhw1command_buffer_execution_barrier(
    iree_hal_command_buffer_t* base_command_buffer,
...
static iree_status_t iree_halhw1command_buffer_signal_event(
...
static iree_status_t iree_halhw1command_buffer_reset_event(
    iree_hal_command_buffer_t* base_command_buffer, iree_hal_event_t* event,
    iree_hal_execution_stage_t source_stage_mask) {
  iree_halhw1command_buffer_t* command_buffer =
      iree_halhw1command_buffer_cast(base_command_buffer);
...
static iree_status_t iree_halhw1command_buffer_wait_events(
    iree_hal_command_buffer_t* base_command_buffer,
...
static iree_status_t iree_halhw1command_buffer_advise_buffer(
    iree_hal_command_buffer_t* base_command_buffer,
...
static iree_status_t iree_halhw1command_buffer_fill_buffer(
    iree_hal_command_buffer_t* base_command_buffer,
...
static iree_status_t iree_halhw1command_buffer_update_buffer(
...
static iree_status_t iree_halhw1command_buffer_copy_buffer(
    iree_hal_command_buffer_t* base_command_buffer,
...
static iree_status_t iree_halhw1command_buffer_collective(
...
static iree_status_t iree_halhw1command_buffer_dispatch(
    iree_hal_command_buffer_t* base_command_buffer,
...
static const iree_hal_command_buffer_vtable_t
    iree_halhw1command_buffer_vtable = {
        .destroy = iree_halhw1command_buffer_destroy,
        .begin = iree_halhw1command_buffer_begin,
        .end = iree_halhw1command_buffer_end,
        .begin_debug_group = iree_halhw1command_buffer_begin_debug_group,
        .end_debug_group = iree_halhw1command_buffer_end_debug_group,
        .execution_barrier = iree_halhw1command_buffer_execution_barrier,
        .signal_event = iree_halhw1command_buffer_signal_event,
        .reset_event = iree_halhw1command_buffer_reset_event,
        .wait_events = iree_halhw1command_buffer_wait_events,
        .advise_buffer = iree_halhw1command_buffer_advise_buffer,
        .fill_buffer = iree_halhw1command_buffer_fill_buffer,
        .update_buffer = iree_halhw1command_buffer_update_buffer,
        .copy_buffer = iree_halhw1command_buffer_copy_buffer,
        .collective = iree_halhw1command_buffer_collective,
        .dispatch = iree_halhw1command_buffer_dispatch,
};
