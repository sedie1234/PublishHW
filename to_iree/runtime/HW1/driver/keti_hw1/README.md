...
1. Find/replace `keti_hw1` with the friendly name of your driver (e.g. `Vulkan`).
1. Find/replace `_keti_hw1_` with the C name of your driver (e.g. `vulkan`).
1. Find/replace `_KETI_HW1_` with the upper C name of your driver (e.g. `VULKAN`).
1. Find/replace `// TODO(keti_hw1):` with your github ID, your driver name, or a
   GitHub issue number tracking driver creation (e.g. `// TODO(#1234):`).
1. Find/replace `HW1/driver/keti_hw1/` with your source path.
